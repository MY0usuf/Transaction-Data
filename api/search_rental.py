...
table = pq.read_table('C:\\Users\\yousu\\Desktop\\Python Projects\\main-flask\\raw_rental_data.parquet')
raw_data = table.to_pandas().reset_index()
...
def search(search_value,column_name):
    ...
    matching_rows.to_csv('C:\\Users\\yousu\\Desktop\\Python Projects\\main-flask\\rental_results.csv', index=False)
